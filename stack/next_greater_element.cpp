 ...
 * element and there is not greater element so we push -1 in answer vector or 
 * else we push the stack top.
 *
 * In the end we reverser the answer vector and print it.
 **/ 
